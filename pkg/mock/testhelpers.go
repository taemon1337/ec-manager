...
func SetupDefaultMockResponses(m *MockEC2Client) {
	...
	m.On("DescribeInstances", mock.Anything, mock.Anything).Return(&ec2.DescribeInstancesOutput{}, nil)
	m.On("DescribeImages", mock.Anything, mock.Anything).Return(&ec2.DescribeImagesOutput{}, nil)
	...
	m.On("DescribeSubnets", mock.Anything, mock.Anything).Return(&ec2.DescribeSubnetsOutput{}, nil)
	m.On("DescribeKeyPairs", mock.Anything, mock.Anything).Return(&ec2.DescribeKeyPairsOutput{}, nil)
}
